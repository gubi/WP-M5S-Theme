...
if($facebook_uid) { //connesso
    ...
    ?>
    <a href="<?php echo $facebook_login_url; ?>" target="_top"><img src="<?php echo get_template_directory_uri_images(); ?>/fb-login.png" alt="<?php echo __('Accedi con Facebook', 'm5s'); ?>" /></a>
    <?php
}
*/
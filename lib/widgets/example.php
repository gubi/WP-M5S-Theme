...
class banner300x250 extends WP_Widget { //****************************************************************** da cambiare
	function banner300x250() { //****************************************************************** da cambiare
		...
		parent::__construct( basename(__FILE__, '.php'), __('Sportando - Banner 300x250', 'm5s'), array('description' => __('Widget for Banner with 300x250 size.', 'm5s')) );
	}
	...
	function form( $instance ) {
		$defaults = array(
			'title' => __('Title', 'm5s'),
			'content' => __('Insert here the Banner (300x250) code.', 'm5s')
		);
		...
		<div>
			<div>
				<label for="<?php echo $this->get_field_name( 'title' ); ?>"><?php echo __('Title', 'm5s'); ?></label>
			</div>
			<div>
		...
		<div>
			<div>
				<label for="<?php echo $this->get_field_name( 'content' ); ?>"><?php echo __('Copy & Paste the code', 'm5s'); ?></label>
			</div>
			<div>

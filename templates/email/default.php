...
<div style="width:600px;margin:0 auto;background:#fff;box-shadow:0 0 15px #ccc;">
    <div style="padding:20px 30px;">
        <div>
            ...
            <div>
                <p><?php echo __("E' stato compilato il form.", 'm5s'); ?></p>
                <p>
                    <?php echo __('Nome', 'm5s')?>: <?php echo $data['first_name']; ?><br />
                    <?php echo __('Cognome', 'm5s')?>: <?php echo $data['last_name']; ?><br />
                    <?php echo __('E-Mail', 'm5s')?>: <?php echo $data['email']; ?><br />
                    <?php echo __('Oggetto', 'm5s')?>: <?php echo $data['subject']; ?><br />
                    <?php echo __('Messaggio', 'm5s')?>: <?php echo $data['msg']; ?><br />
                </p>
            </div>
        </div>
        <div style="margin:20px 0 0 0;">
            <p style="font-size:9px;color:#999;"><?php echo __(sprintf('This message is confidential. It may also be privileged or otherwise protected by work product immunity or other legal rules. If you have received it by mistake please let us know by reply and then delete it from your system; you should not copy the message or disclose its contents to anyone. All messages sent to and from %s may be monitored to censure compliance with internal policies and to protect our business.', get_bloginfo('name')), 'm5s'); ?></p>
        </div>
    </div>
</div>
</body>
